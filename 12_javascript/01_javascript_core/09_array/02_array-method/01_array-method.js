...
console.log(`foodList.indexOf('삼겹살'): ${foodList.indexOf('삼겹살')}`);   // -1 (없을 때)
...
// console.log(`idol1 기준으로 idol2 배열 concat: ${[...idol1, ...(idol2)]}`); // ES6
console.log(`idol3 기준으로 idol1, idol2 배열 concat: ${idol3.concat(idol1, idol2)}`);
...
console.log(`front.: ${front}`);                      // 원본 변경 (치환)

/* join: 배열을 내가 원하는 구분자와 함께 결합하여 문자열로 반환 */
