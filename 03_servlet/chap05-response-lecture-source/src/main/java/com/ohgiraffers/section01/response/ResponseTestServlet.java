...
public class ResponseTestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /* 설명.
         *  1. 요청 받기 (http method GET/POST 요청에 따른 parameter로 전달 받은 데이터 추출 가능
        ...
        * */
        ...
        responseBuilder.append("<DOCTYPE html>\n")
                ...
                .append("</head>\n")
                .append("<body>\n")
                .append("<h1>한글 추가 servlet response</h1>\n")
                .append("</body>\n")
                .append("</html>");

        /* 설명. tomcat 10버전 이전 */ 
        /* 필기. 1) MIME 타입과 인코딩 방식을 response 객체 이용해 따로 설정 */ 
...
//        resp.setContentType("text/html");
        ...
        out.flush();        // outputStream flush 필수
        out.close();
