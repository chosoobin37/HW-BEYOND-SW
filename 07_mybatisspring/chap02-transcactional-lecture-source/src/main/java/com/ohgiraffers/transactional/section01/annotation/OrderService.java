...
public class OrderService {
    ...
    * */
    ...
    /* 설명. 서비스 메소드 내부에서 모든 DML 관련 작업에 예외 없이 잘 동작하면 commit, 예외 발생 시 rollback */
...
//        System.out.println("menuCode = " + menuCode);
        ...
        /* 설명. 2) 주문한 메뉴 별로 Menu 엔티티에 담아서 조회해오기 */
        ...
        /* 설명. 4-1) insert를 하기 위해 테이블과 매칭되는 Entity로 옮겨담음 (DTO -> Entity) */
...
//        );
        ...
        for (int i = 0; i < orderMenuSize; i++) {
            ...
            orderMenu.setOrderCode(order.getOrderCode());       //  entity -> setter 없으므로 생성 필요
