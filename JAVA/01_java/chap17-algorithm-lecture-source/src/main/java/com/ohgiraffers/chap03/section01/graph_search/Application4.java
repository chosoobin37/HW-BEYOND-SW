...
/* 수업목표. BFS와 DFS를 활용해 동일한 결과가 나오는 것 이해 */
public class Application4 {
    ...
    public static String solution(String input) throws IOException {
        ...
        /* 설명. 테스트 코드를 2번째부터 테스트케이스 문자열 넘어오면 앞에 누적되는 것을 지워주고 시작하기 위한 코드 */
        ...
        /* 설명. dfs 할 때 visit 배열 활용 -> 아래 bfs를 위해 다시 false로 채워진 boolean[]로 초기화 */
        visit = new boolean[node + 1];
    ...
    private static void dfs(int start) {
        ...
        /* 설명. node 번호 와 인덱스가 동일한 체계 -> i는 node 번호까지 포함하게 반복해야 함 */
