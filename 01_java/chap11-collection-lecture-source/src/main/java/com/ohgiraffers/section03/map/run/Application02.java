...
public class Application02 {
    public static void main(String[] args) {
        ...
        /* 수업목표. Properties 이해 및 사용 */
        /* 필기.
         *  Properties -> HashMap과 거의 유사하지만 key 값과 value 값 모두를 String으로 사용할 수 있는 자료구조
         *  주로 설정 파일 관련된 파일과의 입출력에 사용 ex) store, load 등
        * */
        ...
        /* 설명. 저장한 파일에서부터 읽어온 데이터를 담은 Properties 객체 */
