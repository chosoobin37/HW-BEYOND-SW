...
public class Application1 {
    ...
    public static Integer solution(String input) throws IOException {
        ...
        // node의 번호와 인덱스 위치를 일치시키기 위해 크기 1 증가 (0번 인덱스 사용 X)
        map = new int[node + 1][node + 1];

        /* 설명. 방문 배열 작성 (방문 배열 작성 이유 -> 이미 방문했던 노드를 다시 stack에 담지 않거나 다시 재귀 함수 호출을 하지 않기 위함) */
        // 방문 배열 노드 번호와 인덱스 번호를 일치시키기 위해 1 증가
